...
@section('content')
                ...
                <!-- <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="title_en" value="{{$partner->title_en}}" class="span6 m-wrap tooltips" data-trigger="hover" data-original-title="Title in English">
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" name="title_ar" value="{{$partner->title_ar}}" class="span6 m-wrap tooltips" data-trigger="hover" data-original-title="Title in Arabic">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea class="span6 m-wrap" name="desc_en" rows="3">{{$partner->desc_en}}</textarea>
                      </div>
                    </div>
                  ...
                  <div class="controls">
                    <textarea class="span6 m-wrap" name="desc_ar" rows="3">{{$partner->desc_ar}}</textarea>
                  </div>
                </div> -->
