...
@section('content')
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="title_en" value="{{$product->title_en}}" class="span6 m-wrap tooltips" data-trigger="hover" data-original-title="Title in English">
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" name="title_ar" value="{{$product->title_ar}}" class="span6 m-wrap tooltips" data-trigger="hover" data-original-title="Title in Arabic">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea class="span6 m-wrap" name="desc_en" rows="3">{{$product->desc_en}}</textarea>
                      </div>
                    </div>
                  ...
                  <div class="controls">
                    <textarea class="span6 m-wrap" name="desc_ar" rows="3">{{$product->desc_ar}}</textarea>
                  </div>
                </div>
								<div class="control-group">
												...
												<div class="controls">
													<select class="span6 m-wrap" name="cat_id" data-placeholder="Choose a Category" tabindex="1">
														...
														@foreach($techs as $tech)
															@if($product->tech_id == $tech->id)
														<option value="{{$tech->id}}" selected>{{$tech->title_en}}</option>
														  @else
															<option value="{{$tech->id}}">{{$tech->title_en}}</option>
															@endif
														@endforeach
													</select>
												</div>
