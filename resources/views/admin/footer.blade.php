...
<script src="{{asset('assets/plugins/bootstrap-daterangepicker/daterangepicker-rtl.js')}}" type="text/javascript"></script>
...
<script type="text/javascript" src="{{asset('assets/plugins/chosen-bootstrap/chosen/chosen.jquery-rtl.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('assets/plugins/jquery-tags-input/jquery.tagsinput.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/plugins/bootstrap-toggle-buttons/static/js/jquery.toggle.buttons.js')}}"></script>
...
<script type="text/javascript" src="{{asset('assets/plugins/jquery-multi-select/js/jquery.multi-select-rtl.js')}}"></script>
...
<script src="{{asset('assets/scripts/form-validation.js')}}"></script>
