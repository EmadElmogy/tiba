...
@section('content')
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
                {!! Form::open(['route'=>'admin.partner.store','files'=>'true']) !!}
                  ...
                  <div class="control-group">
  										...
  										<div class="controls">
  											<input type="text" name="name_en" class="span6 m-wrap tooltips" data-trigger="hover" data-original-title="Name in English">
  										</div>
  									</div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" name="name_ar" class="span6 m-wrap tooltips" data-trigger="hover" data-original-title="Name in Arabic">
                        </div>
                      </div>
